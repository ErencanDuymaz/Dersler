###########################################################################
## Makefile generated for Simulink model 'arduinomega2560_servocontrol_sweep'. 
## 
## Makefile     : arduinomega2560_servocontrol_sweep.mk
## Generated on : Mon Jan 30 20:30:02 2017
## MATLAB Coder version: 3.0 (R2015b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/arduinomega2560_servocontrol_sweep.elf
...
PRODUCT_NAME              = arduinomega2560_servocontrol_sweep
MAKEFILE                  = arduinomega2560_servocontrol_sweep.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/Eren/Desktop/ders
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = arduinomega2560_servocontrol_sweep_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/arduinomega2560_servocontrol_sweep.elf
...
INCLUDES_BUILDINFO = -IC:/MATLAB/SupportPackages/R2015b/arduinobase/toolbox/target/supportpackages/arduinobase/include -IC:/MATLAB/SupportPackages/R2015b/arduinobase/toolbox/target/supportpackages/arduinobase/blocks/sfcn/include -I$(START_DIR)/arduinomega2560_servocontrol_sweep_ert_rtw -I$(START_DIR) -IC:/MATLAB/SupportPackages/R2015b/arduino/toolbox/target/supportpackages/arduinotarget/arduinotargetdemos -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/standard -I$(ARDUINO_ROOT)/libraries/Servo/src -IC:/MATLAB/SupportPackages/R2015b/arduino/toolbox/target/supportpackages/arduinotarget/registry/../include -IC:/MATLAB/SupportPackages/R2015b/arduino/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/include -IC:/MATLAB/SupportPackages/R2015b/arduino-1.6.1/libraries/Servo/src -IC:/MATLAB/SupportPackages/R2015b/arduino-1.6.1/libraries/Servo/src/avr
...
DEFINES_ = -DMODEL=arduinomega2560_servocontrol_sweep -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DON_TARGET_WAIT_FOR_START=1 -DONESTEPFCN=1 -DEXT_MODE=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DRT -DSTACK_SIZE=64 -D_MW_ARDUINO_LOOP_=1 -DMW_ARDUINO_STEP_SIZE=10000 -DMW_ARDUINO_MICROS -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_ANALOG_REF_=0 -D_RTT_NUMSERVOS_=1
...
DEFINES_STANDARD = -DMODEL=arduinomega2560_servocontrol_sweep -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
OBJS = arduinomega2560_servocontrol_sweep.o arduinomega2560_servocontrol_sweep_data.o ext_svr.o updown.o ext_work.o rtiostream_utils.o hooks.o WInterrupts.o wiring.o wiring_analog.o wiring_digital.o wiring_pulse.o wiring_shift.o abi.o CDC.o HardwareSerial.o HardwareSerial0.o HardwareSerial1.o HardwareSerial2.o HardwareSerial3.o HID.o IPAddress.o new.o Print.o Stream.o Tone.o USBCore.o WMath.o WString.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o ext_serial_pkt.o rtiostream_serial_interface.o ext_svr_serial_transport.o rtiostream_serial.o Servo.o
...
%.o : $(START_DIR)/arduinomega2560_servocontrol_sweep_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/arduinomega2560_servocontrol_sweep_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"


%.o : $(START_DIR)/arduinomega2560_servocontrol_sweep_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Servo.o : C:/MATLAB/SupportPackages/R2015b/arduino-1.6.1/libraries/Servo/src/avr/Servo.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
